...
export function getButtYield(callback) {
    ajaxGet('cockpit/buttYield', null, callback)
}

export function getPolishingYield(callback) {
    ajaxGet('cockpit/polishingYield', null, callback)
}
